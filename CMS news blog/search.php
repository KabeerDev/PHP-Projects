        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    $postQuery = "SELECT * FROM post WHERE title LIKE '%$search%' OR description LIKE '%$search%' ORDER BY post_id DESC LIMIT $offset, $limit";
                    ...
                    <?php endif; ?>
                    <?php
                    $q1 = "SELECT * FROM post WHERE title LIKE '%$search%'";
                    ...
                    if (mysqli_num_rows($q1r) > 0) {
                        ...
                        if ($page > 1) {
                            echo "<li><a href='" . $main_url . "search.php?page=" . ($page - 1) . "'>Prev</a></li>";
                        } else {
                        ...
                        if ($page < $totalPage) {
                            echo "<li><a href='" . $main_url . "search.php?page=" . ($page + 1) . "'>Next</a></li>";
                        } else {
