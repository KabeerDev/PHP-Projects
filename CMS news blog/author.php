        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    ?>
                    <h2 class="page-heading"><?= $cat['username'] ?></h2>
                    <?php
                    include("common.php");
                    $limit = 3;
                    if (isset($_GET['page'])) {
                    ...
                    $postQuery = "SELECT * FROM post WHERE author='$id' ORDER BY post_id DESC LIMIT $offset, $limit";
                    ...
                    if (mysqli_num_rows($q1r) > 0) {
                        ...
                        if ($page > 1) {
                            echo "<li><a href='" . $main_url . "author.php?page=" . ($page - 1) . "&a_id=$id'>Prev</a></li>";
                        } else {
                        ...
                        for ($i = 1; $i <= $totalPage; $i++) {
                            ...
                            echo "<li class='" . $active . "'><a href='author.php?page=$i&a_id=$id'>" . $i . "</a></li>";
                        }
                        if ($page < $totalPage) {
                            echo "<li><a href='" . $main_url . "author.php?page=" . ($page + 1) . "&a_id=$id'>Next</a></li>";
                        } else {
