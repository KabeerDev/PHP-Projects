        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    ?>
                    <h2 class="page-heading"><?= $cat['category_name'] ?></h2>
                    <?php
                    include("common.php");
                    $limit = 3;
                    if (isset($_GET['page'])) {
                    ...
                    $postQuery = "SELECT * FROM post WHERE category='$id' ORDER BY post_id DESC LIMIT $offset, $limit";
                    ...
                    ?>
                        ...
                        <?php endwhile; ?>
                    <?php else : ?>
                        <h1 class="text-center text-primary">No posts available in this category.</h1>
                    <?php endif; ?>
                    <?php
                    $q1 = "SELECT * FROM post WHERE category='$id'";
                    ...
                    if (mysqli_num_rows($q1r) > 0) {
                        ...
                        if ($page > 1) {
                            echo "<li><a href='" . $main_url . "category.php?page=" . ($page - 1) . "&c_id=$id'>Prev</a></li>";
                        } else {
                        ...
                        for ($i = 1; $i <= $totalPage; $i++) {
                            ...
                            echo "<li class='" . $active . "'><a href='category.php?page=$i&c_id=$id'>" . $i . "</a></li>";
                        }
                        if ($page < $totalPage) {
                            echo "<li><a href='" . $main_url . "category.php?page=" . ($page + 1) . "&c_id=$id'>Next</a></li>";
                        } else {
